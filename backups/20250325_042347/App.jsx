...
function App() {
  ...
  const generateGuestName = () => {
    ...
    const randomNum = Math.floor(Math.random() * 900) + 100; // Generates a number between 100-999
  ...
  }, [showProximityPrompt, nearbyPlayers, playerPositions, socket, showInteractionMenu, selectedPlayer]);
